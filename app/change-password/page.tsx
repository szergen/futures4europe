...
<div className={classNames(style.UserDashboardWrapper, 'flex flex-col relative m-auto mt-10 mb-6')}>
      <h1 className={classNames(style.headingDashboardh1, 'mt-2 mb-4 p-0')}>Change Password</h1>
      <p className='text-base text-[#606b85]'>Choose a strong password and don't reuse it for other accounts. You may be signed out of your account on some devices. You’ll be signed out of all devices.</p>
      ...
      <div className={classNames(style.dashboardBox, 'mt-14 mb-10 p-8')}>
        <div className='flex flex-col'>
          ...
          <div className='flex flex-col justify-between'>
            ...
            <p className={classNames(style.boxTextDashboard, 'mb-8')}>Use at least 8 characters. Don’t use a password from another site, or something too obvious like your pet’s name.</p>
          </div>
