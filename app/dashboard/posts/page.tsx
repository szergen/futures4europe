...
<div className={classNames(style.UserDashboardWrapper, 'flex flex-col relative m-auto mt-10 mb-6')}>
      <h1 className={classNames(style.headingDashboardh1, 'mt-2 mb-4 p-0')}>My posts</h1>
      <p className='text-base text-[#606b85]'>Would you like to showcase your foresight posts and share insights from your work? You can create your posts here and add various content raging from articles, blog posts, foresight methods, any outputs.</p>
      ...
      <div
        ...
        <div className={classNames(style.dashboardBoxAdd, 'flex flex-col')}>
          ...
          <div className='flex flex-col justify-between'>
            ...
            <p className={classNames(style.boxTextDashboard, 'mb-8')}>Add a detailed overview of your post. Include text content or image. Add any significant outcomes or findings in the foresight community.</p>
          </div>
