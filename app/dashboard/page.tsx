...
<div className={classNames(style.UserDashboardWrapper, 'flex flex-col relative m-auto mt-10 mb-6')}>
      <h1 className={classNames(style.headingDashboardh1, 'mt-2 mb-4 p-0')}>Your profile information</h1>
      ...
      <p className='text-base text-[#606b85]'>Info about you and your preferences across futures4europe services. Manage all your personal information and options. You can make some of this information, like your contact details, visible to others so they can reach you easily. You can also see a summary of your profiles.</p>
          ...
          <div className={classNames(style.listDashboard, 'flex flex-col text-base text-[#606b85]')}>
            <div className={classNames(style.listItemDashboard,'pt-4 pb-4 flex flex-row items-center justify-between')}>
              ...
              <Avatar
                  ...
                  rounded
                  className={classNames(style.avatarUserHeader, 'mr-4 border-none')} // Conditionally add "active" class
                />
            ...
            <div className={'pt-2 pb-2 mt-10 flex flex-col'}>
              <span className='text-[#606b85]'>Who can see your profile photo? </span> <span>Your visibility setting only applies to your profile photo. Your header image is always visible to anyone.</span>
            </div>
