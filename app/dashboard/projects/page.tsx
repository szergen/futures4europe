...
<div className={classNames(style.UserDashboardWrapper, 'flex flex-col relative m-auto mt-10 mb-6')}>
      <h1 className={classNames(style.headingDashboardh1, 'mt-2 mb-4 p-0')}>My projects</h1>
      <p className='text-base text-[#606b85]'>Would you like to showcase your foresight project and share insights from your work? You can upload your project here and add outputs and team members.</p>
      ...
      <div
        ...
        <div className={classNames(style.dashboardBoxAdd, 'flex flex-col')}>
          ...
          <div className='flex flex-col justify-between'>
            <h2 className={classNames(style.headingDashboardh1, 'mt-0 mb-0 flex flex-row items-center')}>
              Project
            </h2>
            <p className={classNames(style.boxTextDashboard, 'mb-8')}>Add a detailed overview of your project. Include its objectives, scope, key activities, and any significant outcomes or findings.</p>
          </div>
          ...
          <div className={classNames(style.listDashboard, 'block')}>
            <Button
              size={'md'}
              color={'light'}
              className={classNames(style.buttonAddDashboard, 'block border-0')}
              onClick={handleCreateProject}
              pill
              >
      ...
      <div className={classNames(style.dashboardBox, 'mt-14 mb-10 p-8')}>
        <div className='flex flex-col'>
          ...
          <div className='flex flex-col justify-between'>
            ...
            <p className={classNames(style.boxTextDashboard, 'mb-8')}>In this section of your account you can manage your list.</p>
          </div>
            ...
            {ownedPostPages.length || ownedInfoPages.length ? (
              <>
                {ownedInfoPages.length > 0 ? (
                  ownedInfoPages
                  .filter((infoPage) => infoPage?.data?.pageTypes[0]?.name === 'project info')
                  .map((infoPage) => (
                      <div className="pt-2 pb-2 flex flex-row items-center justify-between">
                        ...
                        >
                          ...
                          <Button
                            size={'sm'}
                            color={'gray'}
                            className={classNames(style.buttonAddDashboard, 'block mr-2')}
                            pill
                            >
