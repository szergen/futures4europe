...
const GlowButton = ({ children }) => {
    ...
    useEffect(() => {
      ...
      const handlePointerMove = (e) => {
        ...
        let glowStart = getComputedStyle(button).getPropertyValue("--button-glow-start").trim();
        let glowEnd = getComputedStyle(button).getPropertyValue("--button-glow-end").trim();
