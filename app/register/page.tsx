            ...
            <div>
              ...
              <div className="bg-white p-6  md:mx-auto">
                ...
                <div className="text-center">
                    <h3 className="text-base text-gray-900 font-semibold text-center">The account has been successfully created</h3>
                    <p className="text-gray-600 mb-10 my-2">Thank you for registering to Futures4europe</p>
